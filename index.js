        ...
        task.then(snapshot => snapshot.ref.getDownloadURL()).then(url => {
            ...
            // -----------------------------------------call for uploding data into mock api
                var settings = {
                            ...
                            "data": JSON.stringify({"ProductName":productName.val(),"ProductPrice":productPrice.val(),"ProductDiscription":productPrice.val(),"ProductImages":productImages,"ProductCatagoryMenOrWomen":catagoryMenOrWomen.val(),"ProductBrandName":brandName.val(),"ProductUplodedDate":new Date(),"ProductType":typeofProduct.val()}),
                        };
